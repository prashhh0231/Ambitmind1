...
class MapView extends React.Component {
    ...
    getCamera() {
        if (react_native_1.Platform.OS === 'android') {
            return react_native_1.NativeModules.AirMapModule.getCamera(this.map.current);
        }
    ...
    async getMapBoundaries() {
        if (react_native_1.Platform.OS === 'android') {
            return await react_native_1.NativeModules.AirMapModule.getMapBoundaries(this.map.current);
        }
        else if (react_native_1.Platform.OS === 'ios') {
    ...
    takeSnapshot(args) {
        ...
        if (react_native_1.Platform.OS === 'android') {
            return react_native_1.NativeModules.AirMapModule.takeSnapshot(this.map.current, config);
        }
        else if (react_native_1.Platform.OS === 'ios') {
    ...
    addressForCoordinate(coordinate) {
        if (react_native_1.Platform.OS === 'android') {
            return react_native_1.NativeModules.AirMapModule.getAddressFromCoordinates(this.map.current, coordinate);
        }
        else if (react_native_1.Platform.OS === 'ios') {
    ...
    pointForCoordinate(coordinate) {
        if (react_native_1.Platform.OS === 'android') {
            return react_native_1.NativeModules.AirMapModule.pointForCoordinate(this.map.current, coordinate);
        }
        else if (react_native_1.Platform.OS === 'ios') {
    ...
    coordinateForPoint(point) {
        if (react_native_1.Platform.OS === 'android') {
            return react_native_1.NativeModules.AirMapModule.coordinateForPoint(this.map.current, point);
        }
        else if (react_native_1.Platform.OS === 'ios') {
